...
var Note = require("./../models/note.js"); //require the Note model
var News = require("./../models/news.js"); //require the News model
var scraper = require('./../controllers/controller.js'); //require the scrape function
